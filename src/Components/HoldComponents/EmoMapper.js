  ...
  createClass(Dimensions, [
    ...
    },
    {
      ...
      value: function resize() {
        ...
        if (
          this._wrapper.clientWidth > 768 ||
          this._wrapper.clientHeight > 768
        ) {
          if (this._camAR > divAR) {
            this._wrapper.style.height =
              this._wrapper.clientWidth / this._camAR + "px"
            this._wrapper.style.width = "100%"
          } else {
            this._wrapper.style.width =
              this._wrapper.clientHeight * this._camAR + "px"
            this._wrapper.style.height = "100%"
          }
        }
        var guard =
          this._wrapper.clientWidth > this._wrapper.clientHeight
            ? this._wrapper.clientHeight * 0.9
            : this._wrapper.clientWidth
        this._tacker.style.width = this._tacker.style.height =
          guard * 0.83 + "px"
